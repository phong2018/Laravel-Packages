          ...
          <li class="sidebar-dropdown">
            ...
            <div class="sidebar-submenu">
              <ul>
                ...
                @can('viewAny',Phonglg\LaravelEcommerce\Models\Category::class)
                <li>
                    <a href="{{ route('categories.index') }}" class='p-3 text-white'>Payments</a>
                </li>
                @endcan
              </ul>
            </div>
          ...
          <li class="sidebar-dropdown">
            ...
            <div class="sidebar-submenu">
              <ul>
                ...
                <li>
                    <a href="{{ route('customers.index') }}" class='p-3 text-white'>Customer</a>
                </li>
                @endcan
                ...
                @can('backupDB')
                <li>
                    <a href="{{ route('backup.index') }}" class='p-3 text-white'>Backup</a>
                </li>
                @endcan              
              </ul>
            </div>
