<style>
    ...
    .tblMax3D .table_max3d td {font-size: 18px;line-height: 15px; padding: 2px 3px;text-align: center;}
    .tblMax3D .table_max3d .giaiMax3d { font-size: 18px }
    .tblMax3D .table_max3d td strong { font-size: 12px }
    .tblMax3D .table_max3d div {width: 25%;display: inline-block;font-weight: 700;font-size: 24px;line-height: 28px;}
    .tblMax3D .table_max3d .max3d_g1 div { font-size: 38px; width: 40%; line-height: 43px; }
    .tblMax3D .table_max3d .noteGiai {font-style: italic;font-size: 12px;}
