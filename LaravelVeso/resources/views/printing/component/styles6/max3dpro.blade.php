...
.tblMax3D .infoDL { font-weight: bold; font-size: 20px }
...
.tblMax3D .title_kqxs { font-size: 19px; font-weight: bold; line-height: 19px; text-transform: uppercase }
...
.tblMax3D .table_max3d td { letter-spacing: -1.5px; font-size: 15px; padding: 2px 3px; text-align: center;line-height: 15px; }
.tblMax3D .table_max3d .giaiMax3d { font-size: 15px }
.tblMax3D .table_max3d td strong { font-size: 12px }
.tblMax3D .table_max3d div { width: 25%; display: inline-block; font-weight: 600; font-size: 20px; line-height: 21px; }
.tblMax3D .table_max3d .max3d_g1 div { font-size: 30px; width: 40%; line-height: 30px; }
.tblMax3D .table_max3d .noteGiai { font-style: italic; font-size: 14px; line-height: 15px; }
.tblMax3D .table_max3d thead th { padding: 3px 1px; text-transform: uppercase; font-size: 15px; }
.tblMax3D .introduct { font-style: italic; font-size: 13px; background: rgb(239, 239, 239); text-align: center }
