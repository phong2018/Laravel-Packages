...
.tblMega645 .result_number { font-size: 33px; font-weight: bold; border-radius: 50%; height: 53px; width: 43px; border: solid 1px; }
.tblMega645 .title_kqxs { font-size: 25px; font-weight: bold; line-height: 60px }
.tblMega645 .title_slgiai { font-weight: bold; text-decoration: underline; line-height: 40px; }
.tblMega645 .tblTKGiai { border-collapse: collapse; margin: 4px auto 10px auto; border-color: #000; }
.tblMega645 .tblTKGiai td { font-size: 18px; padding: 3px 3px; line-height: 20px;}
.tblMega645 .tblTKGiai thead th { background: #000; color: #FFF; padding: 5px 6px; text-transform: uppercase; font-size: 16px }
.tblMega645 .introduct { padding: 5px; font-size: 14px; line-height: 24px; }
.tblMega645 .domain { font-size: 18px; font-weight: bold; text-decoration: underline }
.tblMega645 input { min-height: 32px; width: 98%; margin: 0 auto; background: #FFC; font-size: 16px; font-weight: bold; text-align: center }
.jackpot_kysau { border-top: solid 2px #2c2c2c; padding-top: 8px; font-family:"UVNSachVo"}
.text-wait {line-height: 70px; font-size:42px}
.jackpot_title { font-weight: bold; text-align: center; text-transform: uppercase; font-size: 33px; line-height: 39px; height: 45px; }
.jackpot_price {font-weight: bold;text-align: center;font-size: 40px;line-height: 30px;background: #000;color: #FFF;height: 45px;}
