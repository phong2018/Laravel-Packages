...
.printing{width:100%}
body { margin: 0 }
#noidung {   margin-left: auto; margin-right: auto; font-family: Arial, Helvetica, sans-serif; }
...
.tblMega645 .infoDL { font-weight: bold; font-size: 19px }
...
.tblMega645 .result_number { font-size: 28px; font-weight: bold; border-radius: 50%; height: 48px; width: 43px; border: solid 1px #000; }
.tblMega645 .result_number.jpPhu { background: #000; color: #FFF }
.tblMega645 .title_kqxs { font-size: 25px; font-weight: bold; line-height: 37px; }
...
.tblMega645 .tblTKGiai td { font-size: 17px; padding: 2px 4px; line-height: 27px; }
...
.jackpot_title { font-weight: bold; text-align: center; text-transform: uppercase; font-size: 25px; line-height: 30px;  
height: 28px; }
.jackpot_price { font-weight: bold; text-align: center; font-size: 31px; line-height: 20px; background: #000; color: #FFF; height: 35px; }
