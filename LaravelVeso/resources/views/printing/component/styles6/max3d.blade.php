...
.tblMax3D .title_kqxs { font-size: 19px; font-weight: bold; line-height: 21px; text-transform: uppercase }
...
.tblMax3D .table_max3d .noteGiai { font-style: italic; font-size: 15px }
