...
<div class="service" style='font-weight:bold'> 
...
<div class="ngaykqxs">
  ...
  <div class="year">{{date("Y", strtotime($prizes[0]['prize_date']))}}</div>
    ...
    <tr> 
      ...
      @for($i=count($prizes)-1;$i>=0;$i--)
        <td colspan='2' class="tentinh"> {{$prizes[$i]['prize_ticketType']}}</td>
      @endfor
  ...
  <tbody>
    ...
    @endfor   
  <tr>
      <td colspan="{{count($prizes)*2+1}}" align="center" style='text-align:center' class="bottom_adv"><strong>In KQXS từ Website: www.thantai39.vn</strong></td>
    </tr>
    </tbody>
</table>
</div>