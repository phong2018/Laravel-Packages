...
.tblMega645 .result_number { font-size: 28px; font-weight: bold; border-radius: 50%; height: 38px; width: 43px; border: solid 1px #000; }
...
.tblMega645 .tblTKGiai td { font-size: 17px; padding: 2px 4px; line-height: 17px; }
