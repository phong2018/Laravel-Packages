...
.tblMax3D { border: double 0px #CCC; background: #FFEFC5;}
.tblMax3D .ngay { font-weight: bold; font-size: 25px }
.tblMax3D .nam { font-weight: bold; font-size: 18px; border-top: solid 2px white }
.tblMax3D .infoDL { font-weight: bold; font-size: 21px }
.tblMax3D .address { font-weight: bold; font-size: 18px }
.tblMax3D .box_result { border-bottom: 0; padding-top: 0px }
...
.tblMax3D .title_kqxs { font-size: 19px; font-weight: bold; line-height: 13px; text-transform: uppercase }
.tblMax3D .title_slgiai { font-weight: bold; text-decoration: underline }
.tblMax3D .table_max3d { border-collapse: collapse; width:100%; border-color: #000; }
.tblMax3D .table_max3d th { line-height: 20px;  border:1px solid #CCC;  text-align: center;}
.tblMax3D .table_max3d td {font-size: 15px; border:1px solid #CCC; padding: 2px 3px; text-align: center;line-height: 15px; }
...
.tblMax3D .table_max3d .max3d_g1 div { color: #aa197f; font-size: 37px; width: 40%; line-height: 39px; }
