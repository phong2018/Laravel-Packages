...
<div class="title"><b>KẾT QUẢ XỔ SỐ  MIỀN NAM</b></div>
...
<div class="ngaykqxs">
  ...
  <div class="year">{{date("Y", strtotime($prizes[0]['prize_date']))}}</div>
    ...
    <tr>
      <td class="thu" rowspan="2">Giải</td>
    ...
    <tr style="display:none">
      <td class="loaive">11K2</td><td class="loaive">AG11K2</td><td class="loaive">11K2</td>
    </tr>
  </thead>
  <tbody>
...
<div class='divPrint'>
<a target='_blank' class='btn btn-print' href="{{route('printing.miennam',['prize_period'=>$prizes[0]['prize_date_Ymd']])}}"><i class="fa fa-fw fa-print"></i> 6 bảng/A4</a>

<a target='_blank' class='btn btn-print' href="{{route('printing.miennam',['prize_period'=>$prizes[0]['prize_date_Ymd'],'numberPrint'=>4])}}"><i class="fa fa-fw fa-print"></i> 4 bảng/A4</a>

<a target='_blank' class='btn btn-print' href="{{route('printing.miennam',['prize_period'=>$prizes[0]['prize_date_Ymd'],'numberPrint'=>1])}}"><i class="fa fa-fw fa-print"></i> 1 bảng/A4</a>

</div> 


@include('laravelhtmldomparser::prizes.component.showLoto',['labelLoTo'=>'Miền Nam']) 
