...
class LaravelApiServiceProvider extends ServiceProvider
{
    ...
    {
        $this->mergeConfigFrom(__DIR__.'/../config/laravelapi.php', 'laravelapi');

        // Register the service the package provides.
        $this->app->singleton('laravelapi', function ($app) {
    ...
    protected function bootForConsole(): void
    {
        ...
        $this->publishes([
            __DIR__.'/../config/laravelapi.php' => config_path('laravelapi.php'),
        ], 'laravelapi.config');
